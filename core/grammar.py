...
def handle_exercise_tab(api_key: str):
    ...
    # Informacja, jeśli użytkownik jeszcze nie sprawdził zdania
    if not st.session_state.get("user_sentence"):
        st.info("✍️ Najpierw wpisz zdanie z użyciem słów z tłumaczenia i kliknij „🔍 Sprawdź zdanie”. Dopiero potem możesz losować kolejne wyrazy.")
